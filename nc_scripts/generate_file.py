...
parser.add_argument('--magic', help='magic number or line to insert')
length_group = parser.add_mutually_exclusive_group()
length_group.add_argument('--file-length', type=int, help='length of file')
length_group.add_argument('--random-file-length', type=str, help='range for random length of file')
content_group = parser.add_mutually_exclusive_group()
content_group.add_argument('--file-content', type=str, help='content with which to fill the file')
content_group.add_argument('--random-file-content', action='store_true', help='fill the file with random content')
